...
CreateMap4 proc
	...
	mov dword ptr CurrentMap[ebx * 4], 1
	inc ebx
	.elseif(ebx == 24 || ebx == 25 || ebx == 35 || ebx == 45 || ebx == 54 || ebx == 56 || ebx == 65 || ebx == 66)
	mov dword ptr CurrentMap[ebx * 4], 2
	inc ebx
	.elseif ebx == 33
	mov dword ptr CurrentMap[ebx * 4], 3
	inc ebx
	.elseif(ebx == 34 || ebx == 44 || ebx == 55 || ebx == 64 || ebx == 75)
	mov dword ptr CurrentMap[ebx * 4], 4
	inc ebx
	.elseif(ebx == 63 || ebx == 73 || ebx == 74 || ebx == 76)
	mov dword ptr CurrentMap[ebx * 4], 5
	inc ebx
	.else
	mov dword ptr CurrentMap[ebx * 4], 0
	inc ebx
	.endif
	.endw
